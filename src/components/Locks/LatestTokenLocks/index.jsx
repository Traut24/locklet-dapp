import { Badge, Box, Button, ButtonGroup, Flex, useColorModeValue as mode, Table, Tbody, Td, Text, Th, Thead, Tr } from '@chakra-ui/react';
      ...
      <Box mx="auto" py="4" px="4" rounded="lg" bg="white" shadow="base" overflowX="auto">
        ...
        <Flex align="center" justify="space-between" mt="4">
          ...
          <ButtonGroup variant="outline" size="sm">
            <Button as={Link} to="/locks" rel="more">View more</Button>
          </ButtonGroup>
        </Flex>
      </Box>
    </>
