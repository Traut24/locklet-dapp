...
export default function NetworkManager() {
  ...
  useEffect(() => {
    ...
    console.log('Route', CHAIN_ID_NETWORK_VALUES[chainId])
...
export const NETWORK_VALUES = ['eth', 'bsc', 'trx', 'bttc'];
...
export const CHAIN_ID_NETWORK_VALUES = {
  ...
  [TrxChainId.NILE]: NETWORK_VALUES[2],

  [BttcChainId.MAINNET]: NETWORK_VALUES[3],
  [BttcChainId.TESTNET]: NETWORK_VALUES[3]
};
