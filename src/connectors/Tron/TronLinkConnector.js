import { __DEV__, PROVIDERS, TrxChainId } from 'src/constants';
...
export class TronLinkConnector extends AbstractTronConnector {
  ...
  async getChainId() {
    ...
    let chainId = blockID ?? -1;
    if (chainId == '0000000000000000de1aa88295e1fcf982742f773e0419c5a9c134c994a9059e') chainId = TrxChainId.NILE;
